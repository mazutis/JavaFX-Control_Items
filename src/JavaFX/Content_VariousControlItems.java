 ...
 */
public class Content_VariousControlItems {
    public void controlItems (Pane parent) {
        System.out.println ("Control Items Box activated");

        Label lblToppicMain = new Label ("Various Control Items");
        lblToppicMain.setFont(Font.font("Verdana", FontWeight.BOLD, 12));
        ...
        layout01.getChildren().addAll(lblToppicMain,lblComboCheck, choiceBox01, check01, check02, check03, check04, check05, choiceBox02,
        ...
        Label lblToppic = new Label ("Various Control Items");
        pane.setCenter(lblToppic);

        parent.getChildren().add(layout00);
    }
